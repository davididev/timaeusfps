...
namespace MagicLightProbes
{
    ...
    public class MagicLightProbes : MonoBehaviour
    {
        ...
        public void CheckState()
        {
            ...
            if (probesVolume == null && gameObject != null)
            {
...
//            }
        ...
        public static GameObject CreateHierarchyStructure(PrefabStage currentPrefabStage)
        {
            ...
            if (currentPrefabStage != null)
            {
                ...
                if (mlpGroupsObject == null)
                {
                    mlpGroupsObject = new GameObject("Magic Light Probes")
                    {
                        transform =
                        {
                            parent = magicToolsObject.transform
                        }
                    };
                }
            }
            else
            {
                ...
                var mlpTransform = magicToolsObject.transform.Find("Magic Light Probes");

                mlpGroupsObject = mlpTransform != null ? mlpTransform.gameObject : null;
                ...
                mlpGroupsObject.gameObject.transform.parent = magicToolsObject.transform;
            }
