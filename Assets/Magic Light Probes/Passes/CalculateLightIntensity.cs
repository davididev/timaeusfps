                ...
                foreach (var light in parent.lights)
                {
                    ...
                    switch (light.lightType)
                    {
                        ...
                        default:
                            ...
                            {
                                if (parent.tmpSharedPointsArray[i].inRangeForLights.
                                    Contains(light) && !parent.tmpSharedPointsArray[i].inShadowForLights.Contains(light))
                                {
                                    ...
                                    foreach (var tracePoint in light.tracePointsData)
                                    {
                                        ...
                                        rayToLight = new Ray(
                                            parent.tmpSharedPointsArray[i].position, 
                                            (tracePoint.position - parent.tmpSharedPointsArray[i].position).normalized);
