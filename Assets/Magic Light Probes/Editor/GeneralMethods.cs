...
namespace MagicLightProbes
{
    ...
    {       
            ...
            if (!magicLightProbes.calculatingVolume)
            {
                ...
                switch (magicLightProbes.selectedTab)
                {
                    ...
                    case 1:
                        ...
                        GUILayout.Label(MLPTooltipManager.MainComponent.GetParameter("Query Hit Backfaces", MLPTooltipManager.MainComponent.Tabs.CullingOptions), GUILayout.MinWidth(200));
                        magicLightProbes.queryHitBackfaces = EditorGUILayout.Toggle(magicLightProbes.queryHitBackfaces, GUILayout.MaxWidth(250));

                        if (magicLightProbes.queryHitBackfaces)
                        {
                    ...
                    case 2:
                        ...
                        GUILayout.Label(MLPTooltipManager.MainComponent.GetParameter("Bounds Display Mode", MLPTooltipManager.MainComponent.Tabs.Debug), GUILayout.MinWidth(150));
        ...
        private static void CreateSettingsAsset(MagicLightProbes magicLightProbes)
        {
            ...
            MLPSettings settingsAsset = ScriptableObject.CreateInstance<MLPSettings>();
