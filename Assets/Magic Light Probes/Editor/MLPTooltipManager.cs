    ...
    public static class MLPTooltipManager
    {
        ...
        public static class MainComponent
        {
            ...
            public static void GenerateTooltips()
            {
                ...
                mainComponentCullingOptions.Add("Query Hit Backfaces", "Allows MLP to detect the back faces of polygons. This can be useful in some cases, but " +
                    "it can also add a lot of extra probes inside objects without colliders or outside the object when the volume covers it completely.");
