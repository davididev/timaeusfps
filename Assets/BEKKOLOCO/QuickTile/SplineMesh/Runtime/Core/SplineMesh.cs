...
namespace SplineMeshTools.Core
{
    ...
    public class SplineMesh : MonoBehaviour
    {
        ...
        void OnDisable()
        {
            // Always unsubscribe to prevent delegate leak on static Spline.Changed
            Spline.Changed -= OnSplineModified;
        }
        ...
        public virtual void GenerateMeshAlongSpline()
        {
            ...
            // Destroy previous generated mesh to prevent leak
            if (meshFilter.sharedMesh != null && meshFilter.sharedMesh != segmentMesh)
            {
